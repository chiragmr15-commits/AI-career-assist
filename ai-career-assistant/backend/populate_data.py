#!/usr/bin/env python
"""
Populate the database with initial data for interview templates and motivational tips
    ...
    templates_data = [
        ...
        },
        {
            ...
            'questions': [
                ...
                "Describe how you would create a dashboard in Tableau/Power BI.",
